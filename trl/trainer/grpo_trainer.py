...
class GRPOTrainer(BaseTrainer):
    ...
    def _calculate_rewards(self, inputs, prompts, completions, completion_ids_list):
        ...
        return rewards_per_func, keys_, vulnerability_rewards
    ...
    def _generate_and_score_completions(
        ...
        rewards_per_func, keys_, vulnerability_rewards = self._calculate_rewards(inputs, prompts_text, completions_text, completion_ids_list)
