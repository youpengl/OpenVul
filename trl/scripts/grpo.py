...
cwe_1000 = load_dataset("anony3849/CWE_Hierarchical_Mapping", split='CWE_1000')
cwe_map = {}
for d in cwe_1000:
...
ground_truth_info = load_dataset("anony3849/Ground_Truth_Vulnerability_Information", split='ground_truth_info')
ground_truth = {}
for d in ground_truth_info:
    ground_truth[d['key']] = d
ground_truth_info = None

checklists = load_dataset("anony3849/Sample_Specification_for_RL_Reward_Evaluation", split='train')
specifications = {}
for d in checklists:
    specifications[d['key']] = {}
    for dd in d['generated_specification']:
        if 'Verdict' in dd['dimension']:
            specifications[d['key']]['prediction'] = dd['description']
        elif 'Evidence' in dd['dimension']:
            specifications[d['key']]['localization'] = dd['description']
        elif 'Reasoning' in dd['dimension']:
            specifications[d['key']]['reasoning'] = dd['description']
checklists = None
